...
@Component({
  templateUrl: './pages/mispunchrequest.component.html',
...
export class MispunchRequestComponent implements OnInit {
  ...
  */
  ngOnInit() {
    ...
    this.httpService.postRequest<ResponseContainer>(requestObj, baseUrl + 'api/AttendanceApi/GetApprovalMispunchRequest').subscribe(
      datas => {
  ...
  */
  ...
  statusSubmit(targetIndex, status) {
    ...
    this.httpService.postRequest<ResponseContainer>(requestObj, baseUrl + 'api/AttendanceApi/ApproveOrRejectApplyMispunch').subscribe(datas => {
      $('.spinner').css('display', 'none');
