...
@Component({
  templateUrl: './pages/employee-attendance.component.html',
  ...
  */
  ...
  searchSubmit() {
    ...
    if (!status) {
      ...
      this.pageNo = 0;
      this.httpService.postRequest<ResponseContainer>(this.submitObj, baseUrl + 'api/AttendanceApi/GetEmployeeAttendance').subscribe(datas => {
        $('.spinner').css('display', 'none');
        if (datas['status'] == 'success') {
...
*/
  nextSubmit() {
    ...
    this.httpService.postRequest<ResponseContainer>(this.submitObj, baseUrl + 'api/AttendanceApi/GetEmployeeAttendance').subscribe(
      datas => {
        $('.spinner').css('display', 'none');
        if (datas['status'] == 'success') {
          this.responseData = datas['data'];
